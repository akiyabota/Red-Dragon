...
//Api Key\\
global.APIKeys = {
	'https://zenzapis.xyz': 'd6d38e837f0a',
}

global.alivemsg = `📤I am alive now😇
🤷‍♀️How can I help you?😉` //Costomize Alive Message ( `???? ☠️┇⃞̳̳̳̳̳̺̿̿̿̿̿͆✥̥̥̥̥̥̥̥̥̥̯̯̯̯̊̊̊̊̊̊̊̊̊̊̊̆̆̆̆͜͡ɴᴏᴛʜɪɴɢ ɪᴍᴘᴏꜱɪʙʟᴇ̲̲̖̅̅́༇┇⃞̳̳̳̳̳̺̿̿̿̿̿͆✥̥̥̥̥̥̥̥̥̥̯̯̯̯̊̊̊̊̊̊̊̊̊̊̊̆̆̆̆͜͡☠️` )
...
//owner v card
global.vcardowner = ['+94785918674'] // owner number
global.ownername = "😎☺αкιуα σƒƒι¢ιαℓ♥️☆❤~❯❯" // owner name
global.ytname = "" // 😎☺αкιуα σƒƒι¢ιαℓ♥️☆❤~
global.socialm = "GitHub: ☺️αкιуα σƒƒι¢ιαℓ♥️☆❤~" // github or insta name
global.location = "India, Mizoram, Aizawl" // location

//bot body 
global.alivepic = `https://i.ibb.co/NVXmFWP/Fraudsters-Are-Using-Bots-to-Gain-Access-to-Cryptocurrency-Accounts.jpg` // alive picture \\ use "https://ibb.com" to upload photos. < 1 MB
...
global.owner = ['+94785918674']
global.ownertag = '+94785918674' //your tag number
global.botname = '☺️αкιуα σƒƒι¢ιαℓ♥️☆❤~ - 𝘉𝘖𝘛' //ur bot name
global.packname = "Bot Sticker" // sticker packname
global.author = "☺️αкιуα σƒƒι¢ιαℓ♥️☆❤~" // sticker author
global.dragonemoji = '🧩' // Menu emoji
global.footer = '[ ◉ ☺️αкιуα σƒƒι¢ιαℓ♥️☆❤~-ᴍᴅ ]' //

//database
global.premium = ['+94785918674'] //ur premium numbers
...
fs.watchFile(file, () => {
 ...
 🔴 Dont Share The session.json with others

RED DRAGON WHATSAPP BOT
QR CODE...

Created by: Dark Nitro❤️
