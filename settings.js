...
global.socialm = "GitHub:😎☺αкιуα σƒƒι¢ιαℓ♥️☆❤~" // github or insta name
...
global.botname = '😎☺αкιуα σƒƒι¢ιαℓ♥️☆❤~ - 𝘉𝘖𝘛' //ur bot name
global.packname = "Bot Sticker" // sticker packname
global.author = "😎☺αкιуα σƒƒι¢ιαℓ♥️☆❤~" // sticker author
global.dragonemoji = '🧩' // Menu emoji
global.footer = '[ ◉😎☺αкιуα σƒƒι¢ιαℓ♥️☆❤~-ᴍᴅ ]' //
...
global.mess = {
    ...
    spam: '⚠️ [SPAM] Detected ⚠️\n\nThe emergency security system was activated.\n\nPowered By: *😎☺αкιуα σƒƒι¢ιαℓ♥️☆❤~*',
    caption: 'Generated by: ◉ *😎☺αкιуα σƒƒι¢ιαℓ♥️☆❤~-ʙᴏᴛ*'
} // END \\
    global.limitawal = {
    premium: "Infinity",
    free: 12,
